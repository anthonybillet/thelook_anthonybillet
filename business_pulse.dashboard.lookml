- dashboard: business_pulse
  ...
  - title: Highest Spending Users
    ...
    explore: order_items
    type: looker_map
    fields: [users.approx_location, users.country, order_items.order_count, users.count,
      order_items.total_sale_price, order_items.average_spend_per_user, users.gender]
    pivots: [users.gender]
    filters: {}
